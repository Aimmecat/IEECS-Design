...
int main(void)
{
    ...
    while(1)
    {
        ips114_show_string(0,0,"seekfree");           //显示字符串
        ips114_show_int(0, 20, -56, 4);                    //显示一个8位有符号型数字
        ips114_show_uint(0,40, 56, 4);                    //显示一个8位无符号型数字
        ips114_show_float(0,60,56.356,2,2);            //显示一个浮点数 去除无效0位  整数位显示5位  小数位显示2位
