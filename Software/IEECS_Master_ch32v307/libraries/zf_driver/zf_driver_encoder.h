...
typedef enum    //TIMER引脚枚举
{
    ...
    //----------定时器10----------
    TIM10_CH1_ENCOEDER_B8 = 0x9000+32*1+8,     TIM10_CH2_ENCOEDER_B9   = 0x0000+32*1+9,     //默认引脚
    TIM10_CH1_ENCOEDER_D1 = 0x9100+32*3+1,     TIM10_CH2_ENCOEDER_D3   = 0x0000+32*3+3,     //重定向1
    TIM10_CH1_ENCOEDER_B3 = 0x9200+32*1+3,     TIM10_CH2_ENCOEDER_B4   = 0x0000+32*1+4,     //重定向2
